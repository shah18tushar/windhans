        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-3xl text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-cyan-100 font-extralight">
                ...
                <span className="block text-3xl bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent font-extralight leading-relaxed">
                  Keeping Your Site Flawless
                </span>
              </h1>
              <p className="text-base text-gray-300 max-w-2xl leading-relaxed font-light">
                Proactive updates, security monitoring, and backups handled for
                you. Ensure optimal performance, security, and peace of mind{" "}
            ...
            <div className="max-w-2xl grid grid-cols-2 gap-4">
              {[
                {
                  text: "Conversion Focused UI/UX",
                  desc: "Designs that guide users to act",
                  icon: <IoStatsChart />,
                },
                {
                  text: "Fully Responsive Design",
                  desc: "Flawless experiences across all devices",
                  icon: <BsSearchHeart />,
                },
                {
                  text: "Secure & Scalable Architecture",
                  desc: "Built to protect, ready to grow",
                  icon: <IoRocket />,
                },
                {
                  text: "Pixel-Perfect Visuals",
                  desc: "Stunning design, every screen polished",
            ...
            <div className="relative group">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/20 shadow-2xl backdrop-blur-sm bg-white/5 group-hover:border-white/40 transition-all duration-500">
                <img
                  ...
                  loading="lazy"
                  className="relative z-0 w-full h-full object-cover mb-6"
                  draggable={false}
                />
              </div>
            </div>
